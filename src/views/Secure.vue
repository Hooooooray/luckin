    ...
    <div class="Secure">
        ...
        <div class="secure-box">
            <van-cell-group>
                ...
                <van-cell title="注销账号" @click="destroyBox()" is-link />
            </van-cell-group>
        </div>
        <div class="btn-box">
            <van-button round type="info" size="" @click="logOutBox()">退出登录</van-button>
        </div>
            ...
            <van-popup class="change-box" closeable position="bottom" v-model="isShow">
                ...
                <van-cell-group>
                    ...
                    <div style="margin:15px">
                        <van-button class="v-login" round block type="primary" native-type="submit" @click="change()">
                            确认修改
                        </van-button>
                    </div>
                </van-cell-group>
